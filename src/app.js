...
const swaggerDefinition = {
  openapi: "3.0.3",
  info: {
    title: "OOH Shopping Centre Inventory API", // Title of the documentation
    version: "1.0.0", // Version of the app
    description:
      "This is the swagger specification for OOH Shopping Centre Inventory", // short description of the app
  },
  servers: [
...
const loadRoutes = async (app) => {
  const connect = connector(api, swaggerSpec, {
    onCreateRoute: (method, descriptor) => {
      // logger.debug(
      //   `Interface created : ${method} ${descriptor[0]} ${descriptor[2]} `
      // );
    },
    middleware: {
      roleMiddleware,
